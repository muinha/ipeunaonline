...
@section ('title', 'Criar local de turismo')
...
<!-- Content Header (Page header) -->
	<section class="content-header">
		<h1>Criar um local de turismo</h1>
		  <ol class="breadcrumb">
		    <li><a href="/admin"><i class="fa fa-dashboard"></i> Home</a></li>
		    <li><a href="admin/tourism">Turismo</a></li>
		    <li class="active"><a href="admin/tourism/create">Cadastrar</a></li>
		</ol>
	</section>
<!-- Main content -->
		  	...
		  	<div class="col-md-12">
		  		<div class="box box-success">
			        <div class="box-header with-border">
			          <h3 class="box-title">Novo local de turismo</h3>
			        </div>
			        <!-- /.box-header -->
			        <!-- form start -->
